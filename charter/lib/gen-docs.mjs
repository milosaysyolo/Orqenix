...
const docs = {
  "knowledge-layer": {
    ...
    sections: [
      ...
      "Governance fields (enforcement, confidence, source_trail)",
      "Cross-KB deduplication",
      "Schema migrations",
      "CLI surface",
      "Design decisions",
      "Future work",
  ...
  "marketplace-system": {
    ...
    sections: [
      ...
      "Bump bot",
      "Federated multi-source (Phase 7 preview)",
      "CI policy scan",
      "CLI surface",
      "Design decisions",
      "Future work",
  ...
  "license-gating": {
    ...
    sections: [
      ...
      "Anti-patterns: no phone-home, no UI block",
      "BSL 1.1 boundaries",
      "Production use grant",
      "License revocation",
      "Manual issuance (Phase 4)",
      "Stripe + Lemonsqueezy plan (Phase 10)",
      "CLI surface",
      "Threat model",
      "Design decisions",
      "Future work",
  ...
  "why-pro": {
    ...
    sections: [
      ...
      "What ships in OSS",
      "What ships in Pro",
      "Pricing posture (Phase 4 free for early users)",
      "Pro package: license",
      "Pro package: learning-loop",
      "Pro package: knowledge-intel",
      "BSL 1.1 plain English",
      "Small org grant (<10 seats)",
      "Non-production grant",
      "When do you need Pro",
      "Migration path",
      "Comparison: OSS vs Pro feature table",
  ...
  "phase-4-rollback": {
    ...
    sections: [
      ...
      "Tag revert workflow",
      "User-facing rollback via lifecycle",
      "Database migration considerations",
      "Schema downgrade plan",
      "CAS preservation during rollback",
      "Communication plan",
      "Post-mortem template",
      "Test rollback drill",
      "Recovery time objective (RTO)",
      "Recovery point objective (RPO)",
      "Decision tree: revert vs hotfix",
