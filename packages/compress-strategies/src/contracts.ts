...
export const TaggedMessageSchema = z
  .object({
...
export class CompressionError extends OrqenixError {
  constructor(reason: string) {
    super(`compression error: ${reason}`, "COMPRESSION");
  }
}
export class Tier0ViolationError extends OrqenixError {
  constructor(messageId: string) {
    super(`tier-0 message ${messageId} cannot be dropped or summarized`, "TIER0_VIOLATION");
  }
}
