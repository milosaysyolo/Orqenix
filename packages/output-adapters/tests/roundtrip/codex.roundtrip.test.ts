...
const FIXTURES = [
  JSON.stringify(
    { schema_version: 'gpt-export-v1', name: 'Code Reviewer', description: 'Reviews code', instructions: 'Review for bugs.' },
    null,
    2
  ),
  JSON.stringify(
    { schema_version: 'gpt-export-v1', name: 'Doc Writer', description: 'Writes docs', instructions: 'Generate docs.' },
    null,
    2
  ),
];
