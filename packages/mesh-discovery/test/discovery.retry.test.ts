...
describe("MeshDiscovery retry edge cases (FK-1.1)", () => {
  ...
  it("retries scheduleBootstrapAttempt with exponential backoff until success", async () => {
    ...
    d.scheduleBootstrapAttempt("/ip4/127.0.0.1/tcp/1/p2p/12D3KooWFakePeer", attemptFn, () => 0.5);
  ...
  it("caps backoff at maxDelayMs after enough failures", async () => {
    ...
    d.scheduleBootstrapAttempt("/ip4/127.0.0.1/tcp/2/p2p/12D3KooWFakePeer", attemptFn, () => 0.5);
  ...
  it("stops scheduling new attempts after MeshDiscovery.stop()", async () => {
    ...
    d.scheduleBootstrapAttempt("/ip4/127.0.0.1/tcp/3/p2p/12D3KooWFakePeer", attemptFn, () => 0.5);
  ...
  it("attempt counter resets on success path", async () => {
    ...
    d.scheduleBootstrapAttempt("/ip4/127.0.0.1/tcp/4/p2p/12D3KooWFakePeer", attemptFn, () => 0.5);
