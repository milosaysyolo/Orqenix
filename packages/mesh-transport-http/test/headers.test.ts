...
import { buildHeaders, assertHeadersMatchBody, b64urlEncode, b64urlDecode, HDR } from '../src/headers.js';
import { CapabilityError, type CapabilityToken, type MeshRequest, type ScopeId } from '@orqenix/mesh-transport-core';
