...
function mem(id: string, tier: 'working' | 'episodic' | 'semantic' | 'procedural', content: string, confidence = 0.8): MemoryEntry {
  return {
    id: `mem:${id.padEnd(32, 'A')}` as any,
    tier, type: 'fact', content,
    contentHash: '0'.repeat(64),
    sourceEntryIds: ['ce:1'], confidence,
    createdAt: '2026-01-01T00:00:00Z',
    lastAccessedAt: '2026-01-01T00:00:00Z',
    accessCount: 0, scopeId: 'scope:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
    metadata: {},
  };
}

const baseMsgs = [{ role: 'system' as const, content: 'You are helpful.' }, { role: 'user' as const, content: 'What did I prefer?' }];
const memList = [
