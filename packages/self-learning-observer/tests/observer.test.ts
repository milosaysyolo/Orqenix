...
describe('Observer', () => {
  ...
  it('queries by action kind', () => {
    observer.capture({ projectId: PROJECT, sessionId: SESSION, actorKind: 'agent', actorId: 'x', actionKind: 'test_run', actionPayload: {} });
    observer.capture({ projectId: PROJECT, sessionId: SESSION, actorKind: 'agent', actorId: 'x', actionKind: 'git_operation', actionPayload: {} });
  ...
  it('queries scoped to a session', () => {
    observer.capture({ projectId: PROJECT, sessionId: SESSION, actorKind: 'agent', actorId: 'x', actionKind: 'tool_call', actionPayload: {} });
    observer.capture({ projectId: PROJECT, sessionId: 'other-session', actorKind: 'agent', actorId: 'x', actionKind: 'tool_call', actionPayload: {} });
