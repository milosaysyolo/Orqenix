...
// @orqenix/ui-primitives, Select primitive
//
// Built on Radix UI Select. Fully accessible dropdown with keyboard navigation,
// typeahead search, position-aware rendering.
//
// Used in Workbench Settings UI for enum-style configuration (e.g., adapter
// presets, model selection, signing enforcement levels).
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "data-pointer-events-none data-opacity-50",
      className,
    )}
    {...props}
  >
