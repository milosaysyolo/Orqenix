...
let issues = 0;
const pkgFiles = execSync('git ls-files "packages/*/package.json" "apps/*/package.json" "plugins/*/package.json"', {
...
if (versions.size > 2) {
  console.warn(`⚠ ${versions.size} distinct versions in workspace. Should typically be 1 (or 2 if mid-transition).`);
}
