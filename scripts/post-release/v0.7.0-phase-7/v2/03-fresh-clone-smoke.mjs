...
writeFileSync(
  resolve(SMOKE_DIR, "package.json"),
  JSON.stringify(
    { name: "orqenix-smoke", private: true, type: "module", version: "0.0.0" },
    null,
    2,
  ),
);
...
const leakCheck = spawnSync(
  "grep",
  ["-rE", '"workspace:|^link:', "node_modules/@orqenix-cloud", "node_modules/@orqenix"],
