...
export const PHASE_REGISTRY = {
  ...
  'phase-7': {
    ...
    provides: {
      ...
      contracts: ['single BLAKE3 audit chain per project', 'D7.13 canonical form', 'verifiable chain'],
    },
    consumes: ['phase-6'],
  },
  'phase-8': {
    ...
    provides: {
      packages: [
        '@orqenix/workbench', '@orqenix/ui-primitives', '@orqenix/memory-engine',
        '@orqenix/plugin-core', '@orqenix/settings-registry', '@orqenix/mcp-server',
        '@orqenix/marketplace-core', '@orqenix/normalization-engine',
        '@orqenix/self-learning-observer', '@orqenix/self-learning-detection',
        '@orqenix/skill-genesis', '@orqenix/verification-loop',
        '@orqenix/migration-phase-7-to-8',
      ],
      exports: [
        'HierarchyQuery', 'BranchStore', 'SubagentHarnessManager', 'ReturnAbsorber',
        'OrqenixMcpServer', 'MarketplaceManager', 'NormalizationEngine', 'Observer',
        'BasicDetector', 'SkillGenesis', 'VerificationLoop', 'Migrator',
      ],
      contracts: [
        '3-level hierarchy (project/branch/session)', 'branch deep-copy (ADR-E-003)',
        'subagent no-matrix (ADR-E-002)', '14 plugin kinds', 'round-trip fidelity (INV-15)',
        'observer opt-out (INV-17)', 'cross-project show-not-share (INV-18)',
      ],
    },
