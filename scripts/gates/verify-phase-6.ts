...
const STEPS: Step[] = [
  ...
  {
    name: "G36   Transport Abstraction",
    cmd: "pnpm",
    args: ["tsx", "scripts/gates/G36-transport-abstraction.ts"],
  },
  {
    name: "G37   HTTP Transport",
    cmd: "pnpm",
    args: ["tsx", "scripts/gates/G37-http-transport.ts"],
  },
  {
    name: "G38A  libp2p Foundation",
    cmd: "pnpm",
    args: ["-F", "@orqenix/mesh-transport-libp2p", "run", "gate:G38A"],
  },
  {
    name: "G38B  libp2p Adapters",
    cmd: "pnpm",
    args: ["-F", "@orqenix/mesh-transport-libp2p", "run", "gate:G38B"],
  },
  {
    name: "G39   Mesh Discovery",
    cmd: "pnpm",
    args: ["-F", "@orqenix/mesh-discovery", "run", "gate:G39"],
  },
  {
    name: "G40   Transport Security",
    cmd: "pnpm",
    args: ["-F", "@orqenix/transport-security", "run", "gate:G40"],
  },
  {
    name: "G41   Native Binding CI Matrix",
    cmd: "pnpm",
    args: ["tsx", "scripts/gates/G41-native-matrix.ts"],
  },
  {
    name: "G42   Observability Hooks",
    cmd: "pnpm",
    args: ["-F", "@orqenix/mesh-observability", "run", "gate:G42"],
  },
  {
    name: "G43   Cross-Transport Routing",
    cmd: "pnpm",
    args: ["-F", "@orqenix/mesh-router", "run", "gate:G43"],
  },
];
