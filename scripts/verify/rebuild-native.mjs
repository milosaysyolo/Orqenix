...
if (isWin) {
  ...
  console.log(
    "  Most users do NOT need these because prebuilt binaries are downloaded automatically.",
  );
...
for (const dep of NATIVE) {
  ...
  if (dep === "better-sqlite3") {
    ...
    const r = spawnSync("node", ["../../node_modules/prebuild-install/bin.js", "--verbose"], {
      cwd: dir,
      stdio: "inherit",
      shell: isWin,
      timeout: 120000,
