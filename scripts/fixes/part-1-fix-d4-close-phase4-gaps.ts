...
const REQUIRED_FIELDS = ['name', 'version', 'license', 'type', 'main', 'types', 'exports', 'scripts'] as const;
...
function normalizeManifest(pkgPath: string): void {
  ...
  const knownTopLevel = new Set([
    ...
    'files', 'keywords', 'repository', 'bugs', 'homepage', 'author',
    'orqenix', 'publishConfig', 'engines',
  ]);
