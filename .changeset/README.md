...
This repo uses pure semver for npm versions (e.g., `0.5.0`). Phase milestones are tracked via Git tags only (e.g., `v0.5.0-phase-5`). Do NOT add `-phase-N` to npm versions.
